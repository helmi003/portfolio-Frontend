        ...
        <div className={classes.container__about__rest}>
          ...
          <div>
            <ul>
              <li>
                <span>Collage</span>
                <span className={classes.container__about__rest__def}>dar chaaben el fehri</span>
              </li>
              <li>
                <span>School</span>
                <span className={classes.container__about__rest__row__def}>dar chaaben el fehri</span>
              </li>
              <li>
                <span>high school</span>
                <span className={classes.container__about__rest__row__def}>ISET Sousse</span>
              </li>
            </ul>
          </div>
        </div>
