    ...
    <>
      <div className={classes.container__home}>
        ...
        <div className={classes.container__home__portfolio}>
          <h1>
            Portfolio{" "}
            <Link to="/Portfolio" className={classes.container__home__portfolio__content}>
          ...
          <div className={classes.container__home__portfolio__content}>
            <Link to="/Portfolio">
              <p>
                I am a software developer. I have experience as a full stack
                developer but I lean more to the front end and I have built a
                lot of web apps and some mobile apps. Also, I am always learning
                and experimenting with new technologies (currently learning
                about the ethereum blockchain) and other topics other than
