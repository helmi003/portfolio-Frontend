        ...
        <div className={classes.container__about__rest}>
          ...
          <div>
            ...
            <div>
              ...
              <div>
                <div><span>Next-js</span>  <span>React-js</span> <span>Flutter</span> <span>Angular</span> <span>Symfony</span></div>
                <div><span>Django</span> <span>Node-js</span> <span>PHP</span></div>
                <div><span>Firebase</span> <span>MongoDB</span> <span>MySQL</span></div>
                <div><span>Python</span> <span>Dart</span> <span>Java</span> <span>JavaScript</span> <span>CSS</span><span>HTML</span> </div>
              </div>
            </div>
          </div>
          <div>
