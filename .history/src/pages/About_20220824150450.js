      ...
      <div className={classes.container__about}>
        <div className={classes.container__about__identificator}>
          <div>
            ...
            <br />
            <p>
              I am from Tunisia, Nabeul. A place of beauty and nature.
              22 years old, ambition student, ready for the upcoming.
              Since my childhood, i love gaming and software development. I always try to develop
              stuff with my unique point of view. I also love to create things
              that can be usefull to others.
            </p>
            <br />
            <p>
              I started coding since I was in school. Coding is also an art
