      ...
      <div className={classes.container__about}>
        ...
        <div className={classes.container__about__rest}>
          <div >
            <h1>EDUCATION</h1>
            <div>
              <div className={classes.container__about__rest__col1}>
                <div>Collage</div>
                <div>School</div>
                <div>high school</div>
              </div>
              <div className={classes.container__about__rest__col2}>
                <div className={classes.container__about__rest__part__def}>
                  dar chaaben el fehri
                </div>
                <div className={classes.container__about__rest__part__def}>
                  dar chaaben el fehri
                </div>
                <div className={classes.container__about__rest__row__def}>
                  ISET Sousse
                </div>
              </div>
            </div>
